...
if [[ -v CONFIG_db_names ]]; then
    export CONFIG_db_names
fi

if [[ -v CONFIG_month_names ]]; then
    export CONFIG_month_names
fi

export CONFIG_encrypt_password CONFIG_encrypt CONFIG_mail_address CONFIG_mail_maxattsize CONFIG_mailcontent CONFIG_db_exclude
